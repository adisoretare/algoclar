    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'factorial-5', title: 'Factorial' },
      ...
      },
      {
        ...
        order: 5,
        lessons: [
          { id: 'prelucrari-fara-memorare', title: 'Prelucrări fără memorarea tuturor valorilor', visualizer: 'streaming-stats' },
          { id: 'maxim-si-minim', title: 'Maxim și minim', visualizer: 'max-min-scan' },
          { id: 'primele-doua-maxime', title: 'Primele două maxime sau minime', visualizer: 'doua-maxime' },
      ...
      },
      {
        ...
        lessons: [
          { id: 'notiunea-de-vector', title: 'Noțiunea de vector', visualizer: 'acces-vector' },
          ...
          { id: 'bubble-sort-5', title: 'Bubble sort', visualizer: 'bubble-sort' },
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'secvente-lungime-fixa', title: 'Secvențe de lungime fixă', visualizer: 'sliding-window' },
          { id: 'secvente-maximale', title: 'Secvențe maximale cu proprietăți', visualizer: 'two-pointers' },
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'adunare-numere-mari', title: 'Adunarea numerelor mari', visualizer: 'big-numbers' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'putere-logaritmica', title: 'Ridicare la putere în timp logaritmic', visualizer: 'matrix-expo' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'notiunea-de-stiva', title: 'Noțiunea de stivă', visualizer: 'stack' },
          { id: 'operatii-stiva', title: 'Operații cu stiva', visualizer: 'stack' },
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'submultimi', title: 'Submulțimi', visualizer: 'backtracking' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'notiunea-de-coada', title: 'Noțiunea de coadă', visualizer: 'queue' },
          { id: 'operatii-coada', title: 'Operații cu coada', visualizer: 'queue' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'notiunea-de-deque', title: 'Noțiunea de deque', visualizer: 'deque' },
          { id: 'operatii-deque', title: 'Operații cu deque', visualizer: 'deque' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'puncte-in-plan', title: 'Puncte în plan', visualizer: 'geometry-basics' },
          { id: 'distanta-doua-puncte', title: 'Distanța dintre două puncte', visualizer: 'geometry-basics' },
          { id: 'arii', title: 'Arii' },
    ...
    chapters: [
      {
        ...
        lessons: [
          ...
          { id: 'recursivitate', title: 'Recursivitate', visualizer: 'recursion' },
          { id: 'algoritmul-fill', title: 'Algoritmul de fill', visualizer: 'lee-fill' },
          { id: 'algoritmul-lee', title: 'Algoritmul lui Lee', visualizer: 'lee-fill' },
          { id: 'sqrt-decomposition', title: 'Square Root Decomposition', visualizer: 'sqrt-decomposition' },
          { id: 'programare-dinamica-baraj', title: 'Programare dinamică', visualizer: 'dp-table-1d' },
    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'exponentiere-rapida-9', title: 'Exponențiere rapidă', visualizer: 'matrix-expo' },
        ],
      },
      {
        id: 'sisteme-biti-9',
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'operatii-multimi-9', title: 'Operații cu mulțimi', visualizer: 'set-map' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'submultimi-9', title: 'Submulțimi', visualizer: 'backtracking' },
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        order: 2,
        lessons: [
          { id: 'stiva-10', title: 'Stiva', visualizer: 'stack' },
          { id: 'coada-10', title: 'Coada', visualizer: 'queue' },
          { id: 'algoritmul-lee-10', title: 'Algoritmul lui Lee', visualizer: 'lee-fill' },
          { id: 'deque-10', title: 'Deque', visualizer: 'deque' },
          { id: 'liste-simplu-inlantuite', title: 'Liste simplu înlănțuite', visualizer: 'linked-list' },
          { id: 'liste-dublu-inlantuite', title: 'Liste dublu înlănțuite', visualizer: 'linked-list' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'stl-deque', title: 'deque', visualizer: 'deque' },
          { id: 'stl-queue', title: 'queue', visualizer: 'queue' },
          { id: 'stl-priority-queue', title: 'priority_queue', visualizer: 'heap' },
          { id: 'stl-stack', title: 'stack', visualizer: 'stack' },
          { id: 'stl-set', title: 'set' },
          { id: 'stl-multiset', title: 'multiset' },
          { id: 'stl-unordered-set', title: 'unordered_set' },
          { id: 'stl-map', title: 'map', visualizer: 'set-map' },
          { id: 'stl-multimap', title: 'multimap' },
          { id: 'stl-unordered-map', title: 'unordered_map', visualizer: 'set-map' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'adunare-numere-mari-10', title: 'Adunare', visualizer: 'big-numbers' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'apel-recursiv', title: 'Apel recursiv', visualizer: 'recursion' },
          { id: 'stiva-apelurilor', title: 'Stiva apelurilor', visualizer: 'recursion' },
      ...
      },
      {
        ...
        order: 7,
        lessons: [
          { id: 'ideea-divide-et-impera', title: 'Ideea metodei Divide et Impera', visualizer: 'divide-et-impera' },
          ...
          { id: 'exemple-clasice-divide', title: 'Exemple clasice', visualizer: 'divide-et-impera' },
        ],
      },
      {
        id: 'geometrie-10',
        ...
        lessons: [
          ...
          { id: 'distanta-doua-puncte-10', title: 'Distanța dintre două puncte', visualizer: 'geometry-basics' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'backtracking-elementar', title: 'Backtracking elementar', visualizer: 'backtracking' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'ideea-programarii-dinamice', title: 'Ideea programării dinamice', visualizer: 'dp-table-1d' },
          { id: 'stari-dp', title: 'Stări' },
          { id: 'tranzitii-dp', title: 'Tranziții' },
          { id: 'initializare-dp', title: 'Inițializare' },
          { id: 'probleme-numarare-dp', title: 'Probleme de numărare', visualizer: 'dp-table-2d' },
          { id: 'probleme-optimizare-dp', title: 'Probleme de optimizare', visualizer: 'knapsack' },
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        order: 4,
        lessons: [
          { id: 'bfs', title: 'BFS', visualizer: 'graph-bfs' },
          { id: 'dfs', title: 'DFS', visualizer: 'graph-dfs' },
          { id: 'componente-conexe', title: 'Componente conexe', visualizer: 'connected-components' },
          { id: 'componente-tare-conexe', title: 'Componente tare conexe', visualizer: 'scc-kosaraju' },
          { id: 'algoritmul-kosaraju', title: 'Algoritmul Kosaraju-Sharir', visualizer: 'scc-kosaraju' },
      ...
      },
      {
        ...
        order: 5,
        lessons: [
          { id: 'roy-warshall', title: 'Roy-Warshall', visualizer: 'floyd-warshall' },
          { id: 'sortare-topologica', title: 'Sortare topologică', visualizer: 'topological-sort' },
          { id: 'descompunere-dag', title: 'Descompunerea pe niveluri a unui DAG' },
          { id: 'dijkstra', title: 'Dijkstra', visualizer: 'dijkstra' },
          { id: 'bellman-ford', title: 'Bellman-Ford', visualizer: 'bellman-ford' },
          { id: 'roy-floyd', title: 'Roy-Floyd', visualizer: 'floyd-warshall' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'heap', title: 'Heap', visualizer: 'heap' },
          ...
          { id: 'union-find', title: 'Union-Find / Disjoint Set Union', visualizer: 'dsu' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'kruskal', title: 'Kruskal', visualizer: 'mst-kruskal' },
          { id: 'prim', title: 'Prim', visualizer: 'mst-prim' },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'dp-stari-exponentiale', title: 'DP pe stări exponențiale', visualizer: 'bitmask-dp' },
          { id: 'dp-bitmask', title: 'DP cu bitmask', visualizer: 'bitmask-dp' },
      ...
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'lca', title: 'LCA', visualizer: 'lca' },
          { id: 'diametrul-arborelui', title: 'Diametrul unui arbore' },
          { id: 'fenwick-tree', title: 'Fenwick Tree', visualizer: 'fenwick-tree' },
          { id: 'segment-tree', title: 'Segment Tree', visualizer: 'segment-tree' },
          { id: 'rmq', title: 'RMQ', visualizer: 'rmq' },
        ],
      },
      {
        ...
        isNationalExtension: true,
        lessons: [
          { id: 'sqrt-decomp-1112', title: 'Square Root Decomposition', visualizer: 'sqrt-decomposition' },
