...
const registry: Record<string, Dyn> = {
  ...
  // Clase 5-7 — completări audit
  'fast-power': lazy(() => import('./FastPowerVisualizer'), 'FastPowerVisualizer'),
  'exponentiere-rapida': lazy(() => import('./FastPowerVisualizer'), 'FastPowerVisualizer'),
  'putere-logaritmica': lazy(() => import('./FastPowerVisualizer'), 'FastPowerVisualizer'),
  'exponentiere-modulo': lazy(() => import('./FastPowerVisualizer'), 'FastPowerVisualizer'),
  'matrice-parcurgere': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalVisualizer'),
  'matrix-traversal': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalVisualizer'),
  'parcurgeri-linii': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalLinii'),
  'parcurgeri-coloane': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalColoane'),
  'parcurgeri-diagonale': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalDiagonale'),
  'parcurgeri-spirala': lazy(() => import('./MatrixTraversalVisualizer'), 'MatrixTraversalSpirala'),
  'ciur-eratostene': lazy(() => import('./SieveVisualizer'), 'SieveVisualizer'),
  'ciurul-eratostene': lazy(() => import('./SieveVisualizer'), 'SieveVisualizer'),
  cmmdc: lazy(() => import('./GcdEuclidVisualizer'), 'GcdEuclidVisualizer'),
  euclid: lazy(() => import('./GcdEuclidVisualizer'), 'GcdEuclidVisualizer'),
  'conversii-baze': lazy(() => import('./BaseConversionVisualizer'), 'BaseConversionVisualizer'),
  'conversii-intre-baze': lazy(() => import('./BaseConversionVisualizer'), 'BaseConversionVisualizer'),
  interclasare: lazy(() => import('./MergeVisualizer'), 'MergeVisualizer'),
  merge: lazy(() => import('./MergeVisualizer'), 'MergeVisualizer'),
  'cautare-liniara': lazy(() => import('./LinearSearchVisualizer'), 'LinearSearchVisualizer'),
  'linear-search': lazy(() => import('./LinearSearchVisualizer'), 'LinearSearchVisualizer'),

  // Clase 5-7 — completări audit (val 2)
  'modular-clock': lazy(() => import('./ModularClockVisualizer'), 'ModularClockVisualizer'),
  'restul-impartirii': lazy(() => import('./ModularClockVisualizer'), 'ModularClockRest'),
  'adunare-modulo': lazy(() => import('./ModularClockVisualizer'), 'ModularClockAdunare'),
  'scadere-modulo': lazy(() => import('./ModularClockVisualizer'), 'ModularClockScadere'),
  'inmultire-modulo': lazy(() => import('./ModularClockVisualizer'), 'ModularClockInmultire'),
  'greedy-intervale': lazy(() => import('./GreedyIntervalsVisualizer'), 'GreedyIntervalsVisualizer'),
  'greedy-intervals': lazy(() => import('./GreedyIntervalsVisualizer'), 'GreedyIntervalsVisualizer'),
  'prefix-extrema': lazy(() => import('./PrefixExtremaVisualizer'), 'PrefixExtremaVisualizer'),
  'prefix-max': lazy(() => import('./PrefixExtremaVisualizer'), 'PrefixMaxVisualizer'),
  'sufix-max': lazy(() => import('./PrefixExtremaVisualizer'), 'SuffixMaxVisualizer'),
  transpunere: lazy(() => import('./MatrixTransposeVisualizer'), 'MatrixTransposeVisualizer'),
  'matrix-transpose': lazy(() => import('./MatrixTransposeVisualizer'), 'MatrixTransposeVisualizer'),
  'zone-diagonale': lazy(() => import('./MatrixZonesVisualizer'), 'MatrixZonesVisualizer'),
  'matrix-zones': lazy(() => import('./MatrixZonesVisualizer'), 'MatrixZonesVisualizer'),
  bordare: lazy(() => import('./MatrixBorderVisualizer'), 'MatrixBorderVisualizer'),
  'matrix-border': lazy(() => import('./MatrixBorderVisualizer'), 'MatrixBorderVisualizer'),
  'vectori-directie': lazy(() => import('./DirectionVectorsVisualizer'), 'DirectionVectorsVisualizer'),
  'direction-vectors': lazy(() => import('./DirectionVectorsVisualizer'), 'DirectionVectorsVisualizer'),
  'vecini-4': lazy(() => import('./DirectionVectorsVisualizer'), 'DirectionVectors4'),
  'vecini-8': lazy(() => import('./DirectionVectorsVisualizer'), 'DirectionVectors8'),
  'submatrice-cautare': lazy(() => import('./SubmatrixSearchVisualizer'), 'SubmatrixSearchVisualizer'),
  'submatrix-search': lazy(() => import('./SubmatrixSearchVisualizer'), 'SubmatrixSearchVisualizer'),
}
