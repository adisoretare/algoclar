...
## Inițializarea — capriciul clasic
...
<ObservationBox>
Dacă vrei **prima** apariție a maximului, condiția rămâne `x > maxim` (strict). Dacă vrei **ultima** apariție, schimb-o în `x >= maxim`. Mica diferență decide care poziție returnezi când există duplicate.
</ObservationBox>
