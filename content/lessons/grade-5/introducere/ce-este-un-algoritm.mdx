...
Rezultatul este același — ordinea `b`/`c` nu contează aici. Dar în alți algoritmi ordinea este critică. Exemplu: la sortare, dacă schimbi ordinea comparațiilor obții un șir nesortrat.
