...
Nu cere vector sortat. E cea mai simplă strategie de căutare.
...
**Greșeala 2:** Vrei toate aparițiile dar ai `break` în buclă — te oprești la prima apariție.
